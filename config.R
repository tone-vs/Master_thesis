...
# 02_comtrade_pull.R           -> data/semiconductor/semiconductor_network.csv
...
hs_layer1 <- c("280461","381800","848610","848620","848630","848640","848690","903082")
...
DIRS <- list(
  ...
  analyses_output = "analyses/output",
