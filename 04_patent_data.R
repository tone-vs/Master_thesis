...
#   + TWN (Taiwan — not in Comtrade but present in the network via BTIGE).
...
patent <- read_csv(file.path(DIRS$raw, "oecd_patents_wipo.csv"), show_col_types = FALSE)
...
# Save
write_csv(patents_avg, file.path(DIRS$processed, "patents_avg.csv"))
