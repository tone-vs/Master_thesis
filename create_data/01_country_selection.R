...
#   data/processed/total_exports.csv      — total exports for RCA denominator
...
write_csv(
  ...
  file.path("data/processed", "country_selection.csv")
)
...
saveRDS(reporters,         file.path("data/processed", "reporters.rds"))
message("Saved: country_selection.rds, reporters.rds")
message("Next: run create_data/02_comtrade_pull.R")
